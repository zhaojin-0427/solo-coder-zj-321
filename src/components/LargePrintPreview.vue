...
<template>
  <Teleport to="body">
    ...
    >
      <div class="min-h-full w-full flex flex-col items-center justify-start sm:justify-center p-3 sm:p-4">
        <div class="relative w-full max-w-3xl">
          <div
            class="sticky top-2 z-10 flex flex-wrap justify-center gap-2 sm:gap-3 mb-4 no-print py-2"
          >
            <button
              class="flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-blue-500 text-white rounded-xl font-bold shadow-lg hover:bg-blue-600 transition-all text-base sm:text-lg"
              @click.stop="handleExport"
            >
              <FileDown :size="18" class="sm:hidden" />
              <FileDown :size="20" class="hidden sm:block" />
              导出图片
            </button>
            <button
              class="flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-teal-500 text-white rounded-xl font-bold shadow-lg hover:bg-teal-600 transition-all text-base sm:text-lg"
              @click.stop="handlePrint"
            >
              <Printer :size="18" class="sm:hidden" />
              <Printer :size="20" class="hidden sm:block" />
              打印随身卡
            </button>
            <button
              class="flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-gray-500 text-white rounded-xl font-bold shadow-lg hover:bg-gray-600 transition-all text-base sm:text-lg"
          ...
          <div
            ...
            class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-4 sm:p-8 shadow-2xl border-4 border-yellow-200"
            :style="{
